...
const AdminLayout = ({ children, params }: any) => {
  ...
  useEffect(() => {
    ...
    const checkAuth = () => {
      ...
      try {
        ...
        if (parsedUser.username !== userid) {
          console.log(
            `User ${parsedUser.username} trying to access ${userid}'s panel`
          );
          router.push("/signin");
          return;
        }
  ...
  const allMenuItems = [
    {
      ...
      allowedRoles: ["owner", "admin"], // Both can access dashboard
    },
    {
      id: "user-management",
      ...
      allowedRoles: ["admin"], // Only admin can access user management
    },
    {
      id: "product-management",
      name: "Product Management",
      href: `/${userid}/panel/product-management`,
      icon: (
        <svg
          className="h-5 w-5"
          fill="none"
      ...
      allowedRoles: ["owner"], // Only owner can access product management
    },
    {
      id: "web-config",
      name: "Store Config",
      href: `/${userid}/panel/web-config`,
      icon: (
        <svg
          className="h-5 w-5"
          fill="none"
      ...
      allowedRoles: ["owner"], // Only owner can access web config
    },
    {
      id: "links",
      name: "Links",
      href: `/${userid}/panel/links`,
      icon: (
        <svg
          className="h-5 w-5"
          fill="none"
      ...
      allowedRoles: ["owner"], // Only owner can access links
    },
    {
      id: "qr-code",
      name: "QR Code",
      href: `/${userid}/panel/qr-code`,
      icon: (
        <svg
          className="h-5 w-5"
          fill="none"
        ...
        >
          <path
            d="M3 3h5v5H3V3zm13 0h5v5h-5V3zM3 16h5v5H3v-5zm8-8h2v2h-2V8zm4 0h2v2h-2V8zm0 4h2v2h-2v-2zm-4 4h2v2h-2v-2zm4 0h2v2h-2v-2zm0 4h2v2h-2v-2z"
            stroke="currentColor"
            strokeWidth={2}
            strokeLinecap="round"
            strokeLinejoin="round"
      ...
      allowedRoles: ["owner"], // Only owner can access QR code
    },
    {
      id: "social-tree",
      name: "Social Tree",
      href: `/${userid}/panel/social-tree`,
      icon: (
        <svg
          className="h-5 w-5"
          fill="none"
        ...
        >
          <path
            d="M12 4a2 2 0 1 1 0 4 2 2 0 0 1 0-4Zm0 6v2m0 0c0 1.105-.895 2-2 2H8a2 2 0 0 1-2-2v-1m6 1c0 1.105.895 2 2 2h2a2 2 0 0 0 2-2v-1"
            stroke="currentColor"
            strokeWidth={2}
            strokeLinecap="round"
            strokeLinejoin="round"
      ...
      allowedRoles: ["owner"], // Only owner can access social tree
    },
  ];

  // Filter menu items based on user role
  const menuItems = user
    ? allMenuItems.filter((item) => item.allowedRoles.includes(user.type))
    : [];
  ...
  return (
    <div className="flex h-screen bg-gray-50">
      ...
      >
        {/* Logo */}
        <div className="flex items-center justify-center h-16 bg-gradient-to-r from-green-500 to-green-600 shadow-sm">
          <div className="flex items-center gap-2">
            ...
            <h1 className="text-white text-xl font-bold">
              {user.type === "admin" ? "Admin Panel" : "Store Panel"}
            </h1>
          </div>
        </div>
          ...
          <div className="flex items-center gap-3">
            <div
              className={`w-10 h-10 rounded-full flex items-center justify-center ${
                user.type === "admin" ? "bg-blue-500" : "bg-green-500"
              }`}
            >
